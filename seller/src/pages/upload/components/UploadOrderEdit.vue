<template>
  <div class="stepOrderEdit">
    <div class="titleBox">
      ...
      <h6 class="titleText">根据输入内容，核对收件人信息。</h6>
      <strong
        @click="back"
        class="backTopStep"
      >返回重新上传>></strong>
    ...
    <div class="editBox">
      ...
      <div class="tabBox">
        <div class="title">
          ...
          <span class="flex2">收货人姓名</span>
          <span class="flex2">收货人手机号</span>
        ...
        >
          ...
          <span class="flex2 reciveName">{{item.receiverNameCursor}}</span>
          <span class="flex2 recivePhone">{{item.receiverPhoneCursor}}</span>
