  ...
  <div>
    <div class="custom-bread-wrap">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>修改礼品</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
...
export default {
  ...
  methods: {
    ...
    async getGiftByGoodsId() {
      let res = await this.$http({
        url: "/point/getGiftByGoodsId",
        method: "post",
        data: {
      ...
      if (data) {
        ...
        // 仓库id查出来是字符串
        this.form.pointId = data.pointId + "";
        // 分类id查出来是字符串
        this.form.categoryId = data.categoryId + "";
        this.form.giftName = data.giftName;
        this.form.unit = data.unit;
        this.form.taobaoPrice = data.taobaoPrice;
        this.form.price = data.price;
        this.form.weight = data.weight;
        this.form.stock = data.stock;
        this.form.picList = JSON.parse(data.picList);
        this.form.detail = recoverUEImgUrl(data.detail);
        this.form.sort = data.sort ? data.sort : 0;
        this.form.costPrice = data.costPrice;
        this.form.giftSize = data.giftSize;
        this.form.giftCode = data.giftCode;
        this.form.isWeight = data.isWeight;
        this.form.edmType = data.edmType;
