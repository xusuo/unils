        ...
        <div>
          ...
          >
            ...
            <el-form-item
              ...
              prop="tempPca"
            >
              <PCA v-model="form.tempPca" :citylist.sync="form.tempPca" />
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    async queryStationBalanceById(params) {
      ...
      let res = await this.$http({
        url: "/channel/getChannelBalanceById",
        method: "get",
        params
      });
      const { code, data } = res;
    ...
    async getTableData() {
      ...
      // console.log(params);
      let res = await this.$http({
        url: "/channel/queryWithdrawalsDataList",
        method: "get",
        params
      });
      const { data } = res;
  ...
  async created() {
    await this.queryStationBalanceById();
    this.handleSearch();
  }
};
</script>
