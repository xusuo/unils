<template>
  <div>
        ...
        <div class="top-info">
          <div class="user">
            ...
            <span>
              ...
              <i
                class="edit"
                @click="$refs.userEditWxDialog.show(form)"
              >修改</i>
            </span>
            <span>
    ...
    <UserEditWxDialog
      ref="userEditWxDialog"
      @success="updateChangeInfo"
    />

    <UserAllotDialog ref="userAllotDialog" />

    <AddAllotRecordDialog
      ref="addAllotRecordDialog"
      @success="updateChangeInfo"
    />
  </div>
</template>
...
import UserEditWxDialog from "./UserEditWxDialog";
import UserAllotDialog from "./UserAllotDialog";
import AddAllotRecordDialog from "./AddAllotRecordDialog";
  ...
  methods: {
    ...
    async querySellerDetail(params) {
      let res = await this.$http({
        url: "/t-operate/querySellerDetail",
        method: "get",
        params
      });
      const { code, data } = res;
