<template>
  <div>
      ...
      <div class="user-detail-base">
        ...
        <div class="top-info">
          <div class="user">
            ...
            <span>微信：{{form.sellerWx ? form.sellerWx : "--"}}</span>
            <span>注册时间：{{form.registerTime }}</span>
            <span>
              <i
                class="edit"
                @click="$refs.userResetPasswordDialog.show(form)"
              >修改登录密码</i>
            </span>
          </div>
        </div>
        ...
        <div class="middle-info">
          <div class="middle-l">
            <div class="money">
              ...
              <div>
                <p>
                  <span>累计充值金额</span>
                  <strong>{{form.totalRecharge ? form.totalRecharge : 0}}</strong>
                </p>
                <p></p>
              </div>
            </div>
            ...
            <div class="user-level">
              ...
              <p>
                ...
                <b @click="$refs.userEditLevelDialog.show(form, bigPrice);">修改</b>
              </p>
              <ul
                class="price-list"
            ...
            <div class="user-blong">
              ...
              <ul class="info-list">
                ...
                <li>
                  <span>奖金到期日：</span>
                  <strong>
                    <template v-if="form.saleBonusTime">
                      {{form.saleBonusTime | formatYMDHMS}}
                    </template>
                ...
                <li>
                  ...
                  <b
                    class="text-btn"
                    @click="$refs.userEditPeopleDialog.show(form);"
                  >修改</b>
                </li>
                <li>
                  <span>邀请人：</span>
                ...
                <li>
                  ...
                  <strong>
                    ...
                    <b
                      class="operate-log"
                      @click="$refs.userAllotDialog.show(form);"
                    >运营分配记录</b>
                    <b
                      v-if="form.isSellerStatus == 'false' || !form.isSellerStatus || form.isBranchOperate == 'true'"
                      class="text-btn"
                      @click="$refs.userEditMarketDialog.show(form);"
                    >修改</b>
                  </strong>
                </li>
              </ul>
          ...
          <div class="middle-r">
            ...
            <div class="title">
              ...
              <b
                class="add-logs"
                @click="$refs.userEditTypeDialog.show(form);"
              >修改商家类别</b>
            </div>
        ...
        <div class="chart-count-box">
          <div>
            ...
            <b
              class="button-w"
              @click="$router.push('/user/taskList?userName=' + form.sellerPhone)"
            >查看任务列表</b>
            <b
              class="button-w"
              @click="$router.push('/user/packageList?userName=' + form.sellerPhone)"
            >查看包裹列表</b>
          </div>
    ...
    />
    <!-- <WithdrawalDialog ref="withdrawalDialog" /> -->
    <UserEditTypeDialog
      ref="userEditTypeDialog"
      @success="updateChangeInfo"
    />
    <UserEditLevelDialog
      ref="userEditLevelDialog"
      @success="updateChangeInfo"
    />
    <UserEditPeopleDialog
      ref="userEditPeopleDialog"
      :saleList="saleList"
    />
    <UserAllotDialog ref="userAllotDialog" />
    <UserEditMarketDialog
      ref="userEditMarketDialog"
      :operateList="operateList"
    />

    <UserResetPasswordDialog ref="userResetPasswordDialog" />
  </div>
</template>
...
import UserEditTypeDialog from "./UserEditTypeDialog";
import UserEditLevelDialog from "./UserEditLevelDialog";
import UserEditPeopleDialog from "./UserEditPeopleDialog";
import UserAllotDialog from "./UserAllotDialog";
  ...
  methods: {
    ...
    updateChangeInfo(o) {
      if (o.type === 1) {
        ...
        // 修改等级
        this.form.sellerLevel = o.sellerLevel;
      } else if (o.type === 3) {
        // 修改类别
        this.form.sellerType = o.sellerType;
      }
    ...
    async querySellerDetail(params) {
      let res = await this.$http({
        url: "/t-station/querySellerDetail",
        method: "get",
        params
      });
      const { code, data } = res;
      if (code === 200) {
        ...
        this.bigPrice = data.bigPrice;

        this.form.xffirst = data.sellerInfo.xffirst;
        this.form.first = data.sellerInfo.first;
        this.form.firstKg = data.sellerInfo.firstKg;
        this.form.additional = data.sellerInfo.additional;
        this.form.farFirst = data.sellerInfo.farFirst;
        this.form.farFirstKg = data.sellerInfo.farFirstKg;
        this.form.farAdditional = data.sellerInfo.farAdditional;
